...
if (isset($_POST["ok"])) {
    ...
    $sqlsel = "SELECT * FROM basket LEFT JOIN product ON basket.proid = product.proid WHERE basket.bcus='$cname'";
    ...
    for ($i = 0; $i < $num_rows; $i++) {
        ...
        // อัปเดตสถานะของสินค้าในตะกร้า
        $sqlup_ostatus = "UPDATE basket SET bstatus = '1', oid='$id' WHERE bid='$bid'";
...
<table width="90%" class="table table-striped table-bordered">
    ...
    ?>
            ...
            <tr>
                ...
                <td>
                    <a href="index.php?page=order_save_del.php&id=<?php echo $rowl["bid"]; ?>
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="form-group" style="text-align: left;">
                                    ...
                                    <input type="text" class="form-control" id="oaddr" name="oaddr" required>
                                    <br><label for="otel">เบอร์โทรที่ติดต่อได้</label>
                                    <input type="text" class="form-control" id="otel" name="otel" required>
                                </div>
                            </div>
                            <div class="col-sm-4" style="margin: auto;">
                                <img class="img-thumbnail" src="image/show.jpg" width="250" height="250">
                            </div>
                        </div>
                        <br>
                        <input type="button" class="btn btn-info" value="สั่งสินค้าเพิ่ม" onclick="window.location='index.php?page=productall.php'" />
                        <?php if ($numl > 0) { ?>
