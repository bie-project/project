    ...
    <div class="row">
        ...
        ?>
            <div class="col-3 d-flex">
                <div class="card" style="flex: 1; box-shadow: -1px -2px 8px #000000; border-radius: 5px; padding: 10px; display: flex; flex-direction: column; justify-content: space-between; margin: 8px;"> <!-- Add margin here -->
                    <div>
